...
if (isset($_SESSION['user_id']) && isset($_SESSION['username'])) {
    ...
    echo '<div class="green-background">Welcome, ' . $usernames . '. You are logged in.</div>';

    // Rest of your "Forums.php" code goes here
...
// Query to count the number of users in the 'logs' table
$sql = "SELECT COUNT(*) as userCount FROM logs";
...
<body>
    ...
    <header>
        ...
        Members: <span id="members"><?php echo $userCount; ?></span>
    </header>
    ...
    try {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<button class="react-button" data-reaction="👍" onclick="reactToPost(this)">👍 ' . 12 . '</button>';
            echo '<button class="react-button" data-reaction="👎" onclick="reactToPost(this)">👎 ' . 11 . '</button>';
            echo '<button class="react-button" data-reaction="❤️" onclick="reactToPost(this)">❤️ ' . 11 . '</button>';
            echo '</div>';
